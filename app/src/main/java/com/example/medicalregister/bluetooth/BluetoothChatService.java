 ...
 */
package com.example.medicalregister.bluetooth;
...
public class BluetoothChatService {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(BlueUtil.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
     ...
     *
     * @param mac 要连接的BluetoothDevice
     */
    public synchronized void connect(String mac) {

        BluetoothDevice remoteDevice = mAdapter.getRemoteDevice(mac);
...
//        }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
       ...
       /* // 取消接受线程，因为我们只想连接到一个设备
        ...
        //将连接的设备的名称发送回UI活动
        Message msg = mHandler.obtainMessage(BlueUtil.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(BlueUtil.DEVICE_NAME, device.getName());
        bundle.putString(BlueUtil.DEVICE_ADDRESS, device.getAddress());
        msg.setData(bundle);
        mHandler.sendMessage(msg);
        //存连接地址
        // TODO: 2022/6/23 先注释
//        SPUtils.put(App.getApp(), SPContant.BLUETOOTH_ADDRESS, device.getAddress());
    ...
    private void connectionFailed() {
        ...
        // 将失败消息发送回活动
        Message msg = mHandler.obtainMessage(BlueUtil.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BlueUtil.TOAST, "无法连接设备");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(BlueUtil.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BlueUtil.TOAST, "丢失设备连接");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(BlueUtil.MESSAGE_READ, bytes, -1, buffer)
        ...
        public void write(byte[] buffer) {
            try {
                ...
                //将发送的消息共享回UI活动
                mHandler.obtainMessage(BlueUtil.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
