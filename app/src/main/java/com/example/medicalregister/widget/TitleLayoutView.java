...
public class TitleLayoutView extends LinearLayout {
    ...
    public TitleLayoutView(Context context, @Nullable AttributeSet attrs) {
    ...
    public TitleLayoutView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        view = LayoutInflater.from(context).inflate(R.layout.include_title_layout, this);
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.TitleLayoutView, defStyleAttr, 0);
        name = array.getString(R.styleable.TitleLayoutView_tlv_name);
        right=array.getString(R.styleable.TitleLayoutView_tlv_right);
//        text=array.getString(R.styleable.PwdTextEditView_peev_text);
    ...
    // 双向绑定 输入框内容
    @BindingAdapter(value = "tlv_title_name")
    public static void setcustomContent(TitleLayoutView view, String values) {
