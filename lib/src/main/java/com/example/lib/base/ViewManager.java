...
public class ViewManager {
    ...
    private static List<MvvmFragment> fragmentList;
    ...
    public void addFragment(int index, MvvmFragment fragment) {
    ...
    public MvvmFragment getFragment(int index) {
        if (fragmentList != null) {
    ...
    public List<MvvmFragment> getAllFragment() {
        if (fragmentList != null) {
            return fragmentList;
        }
        return null;
